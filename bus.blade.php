...
<body>
        ...
        <div class="row">
            <div class="col-md-12">
                <form action="{{ route('searchBuses') }}" method="post">
                    ...
                    <div class="form-group">
                        <label for="Journey_Date">Journey_Date</label>
                        <input type="date" class="form-control" id="Journey_Date" name="Journey_Date" required>
                    </div>
                    <div class="form-group">
                        <label for="Return_Date">Return_Date (Optional)</label>
                        <input type="date" class="form-control" id="Return_Date" name="Return_Date">
                    </div>
                    
                    <div class="form-group text-center">
                        <button type="" class="hvr-underline-from-center"><a href="bussearch" >Search Buses</a></button>
                    </div>
                </form>
            </div>
        </div>
    ...
    <section id="additional-text" class="container">
        <div class="row">
            <div class="col-md-12">
                <h2 style="color: #333; text-align: center;">Book bus tickets in 3 easy steps</h2>
    ...
    <section class="container">
        <div class="row">
            <div class="col-md-12">
                <img id="bus-image" src="img/bus_image.jpg" alt="Bus Image">
            </div>
        </div>
    </section>
