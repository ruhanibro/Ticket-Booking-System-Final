 ...
 <div class="container">
  <div class="row">
   ...
   <div class="middle_2 clearfix">
	...
	<div class="col-sm-6">
	 <div class="middle_4">
	  <a href="#"><img src="img/middle.jpg" alt="abc" class="img_responsive"></a>
	 </div>
	</div>
	<div class="col-sm-3">
	 <div class="middle_5">
   ...
   <div class="our_1 clearfix">
    <div class="col-sm-4">
     ...
     <div class="our_5 clearfix">
	  <div class="col-sm-5 space_all">
	   <div class="our_6">
	    <a href="#"><img src="img/bus2.png" height="120px" width="150px"></a>
		<p>ENA</p>
	   </div>
	  </div>
	  ...
	  <div class="col-sm-5 space_all">
	   <div class="our_8">
	    <a href="#"><img src="img/greenline.png" height="120px" width="150px"></a>
		<p>GREEN LINE</p>
	   </div>
	  </div>
	 </div>
	...
	<div class="col-sm-4">
     ...
     <div class="our_5 clearfix">
	  <div class="col-sm-5 space_all">
	   <div class="our_6">
	    <a href="#"><img src="img/plane1.png" height="120" width="150"></a>
	  ...
	  <div class="col-sm-5 space_all">
	   <div class="our_8">
	    <a href="#"><img src="img/plane2.png" height="120" width="150"></a>
